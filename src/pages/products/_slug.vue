  ...
  <div class="bg-blueGray-50">
    <div class="p-8 mx-auto sm:px-6 lg:px-8 bg-gradient-to-b from-white to-yellow-50 shadow-lg mb-4">
      <div class="flex flex-col text-center w-full">
        <h1 class="text-4xl font-medium title-font text-gray-900">{{ category.name }} в Нижнем Новгороде</h1>
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...
    seoDescription: function () {
      return this.category.seo ? this.category.seo.description : 'Стройматериалы в Нижнем новгороде'
    }
  },

  head() {
    return {
      title: this.category.name + ' в Нижнем Новгороде|| ' + this.seoTitle,
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: this.category.name + ' в наличии в Нижнем Новгороде. ' + this.seoDescription
        }
      ]
    }
  },
