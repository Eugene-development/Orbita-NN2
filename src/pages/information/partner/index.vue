    ...
    <div class="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
      ...
      <div class="relative">
        ...
        <p class="mt-4 max-w-3xl mx-auto text-center text-xl text-gray-500">
          Мы предлагаем взаимовыгодное сотрудничество с контрагентами разной коммерческой напраленности
        </p>
      </div>
...
export default {
  ...
  data() {
    return {
      title: 'Стройматериалы в Нижнем Новгороде || Информация партнёрам стройбазы "Орбита-строй"',
      description: '',
    }
  },
  head() {
