...
<div>
  ...
  <footer class="bg-gradient-to-b from-yellow-300 to-yellow-200" aria-labelledby="footerHeading">
              ...
              <ul class="mt-4 space-y-4">
                <li class="flow-root">
                  <NuxtLink
                    ...
                    <span class="ml-4 text-gray-600">Партнёры</span>
                  </NuxtLink>
                </li>
              ...
              <ul class="mt-4 space-y-4">
                <li class="flow-root">
                  <NuxtLink
                    ...
                    <span class="ml-4 text-gray-600">Юр. лица</span>
                  </NuxtLink>
                </li>
                ...
                <li class="flow-root">
                  <NuxtLink
                    ...
                    <span class="ml-4 text-gray-600">Стройбригады</span>
                  </NuxtLink>
                </li>
                ...
                <li class="flow-root">
                  <NuxtLink
                    ...
                    <span class="ml-4 text-gray-600">Продавцы</span>
                  </NuxtLink>
                </li>
                ...
                <li class="flow-root">
                  <NuxtLink
                    ...
                    <span class="ml-4 text-gray-600">Физ. лица</span>
                  </NuxtLink>
                </li>
              </ul>
            </div>
