          ...
          <div class="md:grid md:grid-cols-1">
            <div>
              ...
              <div class="mt-4 space-y-4">
                  ...
                  <p class="text-base text-gray-600 flex">
                  ...
                  <p class="text-sm text-gray-600 flex">
                    ...
                    <a class="  flex" href="https://vk.com/orbita_stroy"
                      ...
                      <div class="text-sm text-gray-600 hover:text-red-800">
                        vk.com/orbita_stroy
                      </div>
                    </a>
              </div>
...
<!--          </a>-->
        ...
        <p class="mt-8 text-base text-gray-600 md:mt-0 md:order-1">
          &copy; 2021 Интернет магазин строительных, отделочных материалов и пластиковых окон "Орбита-Строй".
        </p>
      </div>
    </div>
  </footer>
