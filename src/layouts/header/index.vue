...
<!--            </a>-->
            <div class="flex lg:ml-8 space-x-8 ">
              <div class="flex items-center">
                <svg aria-hidden="true" class="h-4 w-4 text-red-900" fill="none" stroke="currentColor"
                ...
                <p class="ml-2 text-red-900 animate-pulse">
                  8 (800) 555-8-111 (звонок бесплатный), 8 (930) 688-88-62, 8 (902) 303-36-54
                </p>
              </div>
...
<!--          </div>-->
    ...
    <div class="relative bg-gradient-to-tr from-yellow-100 via-yellow-300 to-yellow-100 shadow-lg">
      <div class="flex justify-between items-left mx-8 px-8 py-3 sm:px-6 md:justify-start md:space-x-10">
        ...
        <nav class="hidden md:flex space-x-10 pt-2 text-xl font-medium text-gray-800 hover:text-gray-900">
          <NuxtLink to="/">
            Главная
          </NuxtLink>
...
<!--          </div>-->
    ...
    <nav class="flex border-b-2 border-t-2 py-2 " aria-label="Breadcrumb">
      <div class="flex items-center space-x-4 mx-auto text-gray-900">
        <!--        -->
        <!--          <div class="flex items-center">-->
...
<!--                      class="ml-4 text-xs md:text-sm font-medium hover:text-gray-700">Скидки-->
<!--            </NuxtLink>-->
<!--          </div>-->
