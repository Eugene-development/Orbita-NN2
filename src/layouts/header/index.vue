<template>
  <div>
    <div class="relative bg-yellow-200">
      <div class="flex justify-between items-center mx-8 px-8 py-3 sm:px-6 md:justify-start md:space-x-10">
      ...
      <div class="py-2 px-3 sm:py-6 sm:px-6 lg:px-12 lg:flex lg:justify-between flex items-center ">
        <div class="mr-12 max-w-xs">
          ...
          <span
            ...
            <svg class="mr-1.5 h-2 w-2 text-gray-50" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="max-w-6xl justify-items-center object-center items-center">
...
<!--                    <div class="inline-flex items-baseline px-2.5 py-0.5 rounded-full text-sm font-medium bg-yellow-100 text-yellow-800 md:mt-2 lg:mt-0">-->
<!--                      <svg class="-ml-1 mr-0.5 flex-shrink-0 self-center h-5 w-5 text-yellow-500" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">-->
                ...
                <li class="py-1">
                  <div class="relative focus-within:ring-2 focus-within:ring-red-500">
                    ...
                    <div class="mt-3 text-base flex">
                      ...
                      <p class="ml-2">
                        Пн-Пт 8:00-17:30; <br> Сб 9:00-16:00
                      </p>
                    </div>
                    <div class="mt-3 text-base flex">
                      <svg aria-hidden="true" class="h-6 w-6" fill="none" stroke="currentColor"
...
<!--            <div class="mt-6">-->
<!--              <a-->
<!--                class="w-full flex justify-center items-center px-3 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50"-->
<!--                href="#">-->
<!--                View all-->
<!--              </a>-->
<!--            </div>-->
